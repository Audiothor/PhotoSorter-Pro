...
*   **Détection des Doublons Hybride (v1.13.30) :** Moteur d'indexation MD5 avec cache persistant (`.photosorter_index.json`) et système de détection physique en direct pour une fiabilité totale.
...
PhotoSorter Pro (v1.13.30) est développé avec une architecture claire séparant l'UI, le traitement d'image, le thread d'écoute vocale et le moteur d'indexation de doublons :
